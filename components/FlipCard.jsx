...
export default function Card() {
    return (
        <section className="flex flex-col xl:flex-row md:flex-col  items-center gap-32 px-4 py-10 sm:py-20 sm:px-10 lg:px-24 xl:px-30 2xl:px-60">
...
function generateCard(title, description) {
    return (
        <article className="group w-full md:w-96  [perspective:1000px] pb-14 ">
