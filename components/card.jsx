    ...
    return (
        <div className="flex flex-col md:flex-row justify-center items-center gap-8">
            <div className="group w-full md:w-96 [perspective:10000px]">
                <div className="relative h-80 md:h-96 w-full md:w-96 rounded-xl transition-all duration-500 shadow-xl [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                    <div className="absolute inset-0 overflow-hidden rounded-xl">
                        <div className="bg-[#FCA500] h-full w-full md:w-96 rounded-xl object-cover shadow-xl shadow-black/40">
                    ...
                    <div className="absolute inset-0 h-full w-full md:w-96 rounded-xl bg-black/40 px-12 text-center text-slate-200 [transform:rotateY(180deg)] [backface-visibility:hidden]">
            ...
            <div className="group w-full md:w-96 [perspective:10000px]">
                <div className="relative h-80 md:h-96 w-full md:w-96 rounded-xl transition-all duration-500 shadow-xl [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                    <div className="absolute inset-0 overflow-hidden rounded-xl">
                        <div className="bg-[#FD7211] h-full w-full md:w-96 rounded-xl object-cover shadow-xl shadow-black/40">
                            {/* Título centrado en la tarjeta */}
                            <h3 className="text-4xl font-MontserratBold text-white text-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 transition-opacity group-hover:opacity-0">
                                VISION
                            </h3>
                    ...
                    <div className="absolute inset-0 h-full w-full md:w-96 rounded-xl bg-black/40 px-12 text-center text-slate-200 [transform:rotateY(180deg)] [backface-visibility:hidden]">
                        <div className="flex h-full flex-col items-center justify-center">
                            <p className="text-base overflow-auto">Establecerse como un centro tecnológico de excelencia a nivel nacional y regional.<br />En un ámbito de trabajo en equipo y colaboración</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="group w-full md:w-96 [perspective:10000px]">
                <div className="relative h-80 md:h-96 w-full md:w-96 rounded-xl transition-all duration-500 shadow-xl [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                    <div className="absolute inset-0 overflow-hidden rounded-xl">
                        <div className="bg-[#C9222B] h-full w-full md:w-96 rounded-xl object-cover shadow-xl shadow-black/40">
                            {/* Título centrado en la tarjeta */}
                            <h3 className="text-4xl font-MontserratBold text-white text-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 transition-opacity group-hover:opacity-0">
                                OBJETIVO
                            </h3>
