...
const projectsData = [
    ...
    {
        id: 6,
        name: 'Horizonte Saludable',
        imageSrc: hSaludable,
        link: 'URL_DEL_ENLACE_DEL_PROYECTO_1',
    },
    {
        id: 7,
        name: 'Juventud al Dia',
        imageSrc: juventud,
        link: 'URL_DEL_ENLACE_DEL_PROYECTO_1',
    },
    {
        id: 8,
        name: 'Coincidencia Digital',
        imageSrc: bStreet,
        link: 'URL_DEL_ENLACE_DEL_PROYECTO_1',
    },
    {
    ...
    {
        id: 10,
        name: 'Beyond the Street',
        imageSrc: bStreet,
        link: 'URL_DEL_ENLACE_DEL_PROYECTO_1',
    },
    {
        id: 11,
        name: 'Environmental Restoration Perception',
        imageSrc: Enviromental,
        link: 'URL_DEL_ENLACE_DEL_PROYECTO_1',
    },
];
